...
cp scannetpp_formatted/$SCENE/colmap/cameras_fish.txt scannetpp_formatted/$SCENE/colmap/cameras.txt
cp scannetpp_formatted/$SCENE/colmap/cameras_fish.txt scannetpp_formatted/$SCENE/colmap/cameras_equidist.txt
# awk '{
#     if ($0 ~ /SIMPLE_PINHOLE/) {
