...
FOVMAP_DIR_TRAIN=image_undistorted_fisheye #undistorted_tanmap_fov_"$FOVMOD_TRAIN"_step_"$STEP_TRAIN"/
FOVMAP_DIR_EVAL=undistorted_tanmap_fov_"$FOVMOD_EVAL"_step_"$STEP_EVAL"/
